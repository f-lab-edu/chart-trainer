...
class ChartGameRepositoryImpl @Inject constructor(
    ...
    override suspend fun createNewChartGame(chartGame: ChartGame): Long = withContext(dispatcher) {
    ...
    override suspend fun fetchChartGame(gameId: Long): ChartGame = withContext(dispatcher) {
    ...
    override suspend fun updateChartGame(chartGame: ChartGame) = withContext(dispatcher) {
        listOf(
            launch {
